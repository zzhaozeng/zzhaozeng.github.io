...
排好序了。
    ...
    void qsort(int *arr, int l, int h)                                                                    | 49         if (n == 1) return;                                                                          
    {                                                                                                     | 50                                                                                                      
        if (arr == NULL) return;                                                                          | 51         int i, j;                                                                                    
        if (l >= h) return;                                                                               | 52         for (i = 0; i < n; i++) {                                                                    

        int m = l;                                                                                        | 54                 swap(arr, j-1, j);                                                                   
        int i;                                                                                            | 55                 }                                                                                    
        for (i = l+1; i < h; i++) {                                                                       | 56             }                                                                                        
            if (arr[i] < arr[l])                                                                          | 57                                                                                                      
                swap(arr, ++m, i);                                                                        | 58         assert(issorted(arr, n));                                                                    
        }                                                                                                 | 59     }                                                                                                
        swap(arr, l, m);                                                                                  | 60                                                                                                      
                                                                                                       | 61 #### 快速排序                                                                                        
        qsort(arr, l, m-1);                                                                               | 62                                                                                                      
        qsort(arr, m+1, h);                                                                               | 63 快排是一种分治的排序算法。它将一个数组分成两个小部分，然后对他们排序，当子数组                       
    }
...
种情况下整个数组需要 $n-1$次划分，$n-1$次划分中每次划分都需要$O(n)$时间来去掉一个元素，
